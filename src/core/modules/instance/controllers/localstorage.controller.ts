...
export class LocalStorageController {
  ...
  saveStorageSnapshot = () => {
    this.InstanceService.DebugController.logDebugMessage('Saving snapshot to localStorage')
  ...
  loadStorageSnapshot = () => {
    this.InstanceService.DebugController.logDebugMessage('Loading snapshot from localStorage')
