...
export class LocalStorageController {
  ...
  saveStorageSnapshot = () => {
    ...
    const current =
      this.InstanceService.StateController.StateObserver.target.value;
  ...
  loadStorageSnapshot = () => {
    ...
    this.InstanceService.StateController.quietChangeState(
      localStorageSave.current,
    );
    recursiveReassign(
      this.InstanceService.ReactiveController.ReactiveState,
      localStorageSave.reactive,
    );
  };
}
